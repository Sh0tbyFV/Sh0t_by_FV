[index.html](https://github.com/user-attachments/files/22894719/index.html)[Uploadi<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width,initial-scale=1" />
  <title>Sh0t_by_FV — Sports Photography</title>
  <meta name="description" content="Sh0t_by_FV — Action sports photography. Book sessions, view portfolio, buy prints." />
  <style>
    :root{
      --accent:#ff3b30; /* energetic red */
      --bg:#0b0b0d;
      --card:#121214;
      --muted:#9aa0a6;
    ...
    body{
      margin:0;
      background:linear-gradient(180deg,#050507 0%, #09090a 100%);
      color:#eeeeee;
    ...
    .logo{
      ...
      font-weight:800;
      color:#0b0b0b;
      box-shadow: 0 6px 18px rgba(255,59,48,0.12), inset 0 -3px 6px rgba(0,0,0,0.12);
    ...
    <section id="contact">
      ...
      <div class="contact-grid">
        ...
        <div style="background:var(--card);padding:16px;border-radius:12px;">
          ...
          <p style="color:var(--muted);margin:0 0 12px 0">Phone: <strong>+1 (555) 123-4567</strong><br>Email: <strong>you@example.com</strong></p>
